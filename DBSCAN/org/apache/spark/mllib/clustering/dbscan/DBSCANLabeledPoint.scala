...
class DBSCANLabeledPoint(id: String, vector: Vector) extends DBSCANPoint(id, vector) {

  def this(point: DBSCANPoint) = this(point.id, point.vector)
  ...
  override def toString(): String = {
    s"Element $id in cluster $cluster ($flag)"
  }
